...
@Configuration //arquivio de configuração
@EnableWs //hibiliar spring web service
public class WebServiceConfig extends WsConfigurerAdapter{
	...
	public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema customerSchema) {
		...
		definition.setTargetNamespace("http://jopaulo.com.br");
	...
	public SimplePasswordValidationCallbackHandler callbackHandler() {
		...
		handler.setUsersMap(Collections.singletonMap("joao", "123"));
		return handler;
	}
